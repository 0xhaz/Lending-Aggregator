 ...
 * @notice Contract that facilitates liquidation of vaults user
 */
...
contract LiquidationManager is ILiquidationManager, SystemAccessControl {
  ...
  /**
   * @dev Initiates a flashloan for a liquidation operation
   * @param vault that holds the `users` position
  ...
  /**
   * @dev Checks this address is the flashloan originator. This check applies to a {BorrowingVault} only
