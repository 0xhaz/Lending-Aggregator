...
/**
 * @title LibSigUtils
 * @notice Helper library for permit signing of the vault `permitWithdraw` and `permitBorrow`
 */
...
library LibSigUtils {
  ...
  /// @notice Returns the hash of the permit-withdraw
  ...
  /// @notice Returns the hash of the permit-borrow
