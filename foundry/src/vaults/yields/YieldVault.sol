...
/**
 * @title YieldVault
 * @notice Implementation vault that handles pooled single sided asset
 * for lending and strategies seeking yield
 ...
 * This vault can aggregate protocols that implements yield strategies
 */
...
contract YieldVault is BaseVault {
    ...
    returns (bool)
  {
    ...
    if (debt != 0) revert YieldVault__notApplicable();
