 ...
 * @notice Sets the chainlink price feeds for every chain to be able to use the Oracle
 * @dev Reference to chainlink oracle addresses: https://docs.chain.link/data-feeds/price-feeds/addresses
 */
