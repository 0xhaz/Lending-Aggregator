...
/**
 * @title CompoundV2
 * @notice This contract allows interactions with CompoundV2
...
contract CompoundV2 is ILendingProvider {
  ...
  /**
   * @dev Approves vault's assets as collateral for CompoundV2
  ...
  /**
   * @dev Returns true/false whether the given token is/isn't WETH
