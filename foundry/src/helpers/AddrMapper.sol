...
contract AddrMapper is IAddrMapper, SystemAccessControl {
    ...
    // (e.g Compound_V2 => collateral erc20 => borrow erc20 => protocol market)
    ...
    /**
     * @notice Returns a list of all providers who have a mapping
     */
    ...
    // @inheritdoc IAddrMapper
    function getAddressNestedMapping(string memory providerName, address inputAddr1, address inputAddr2)
        external
        view
        override
        returns (address)
    ...
    // @inheritdoc IAddrMapper
    function setNestedMapping(string memory providerName, address keyAddr1, address keyAddr2, address returnedAddr)
        public
        override
        onlyTimelock
    {
